...
parser.add_argument("-f", "--filter_level", type=str, help="The relative abundance cutoff. Input value must be a percentage (default: %(default)s).", required=False, default=0.1)
